class HomeController < ApplicationController
  def index
    @publishers = Publisher.includes(:video_game_titles).select("publishers.*")
    ...
    @video_game_titles = VideoGameTitle.includes(:video_game_iterations).select("video_game_titles.*")
